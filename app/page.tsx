...
const carsForSale: Car[] = [
  {
    ...
    year: 2023,
    price: 115000,
    imageUrl: 'https://placehold.co/600x400/000000/FFFFFF/png?text=Porsche+911',
  ...
  },
  {
    ...
    year: 2024,
    price: 45000,
    imageUrl: 'https://placehold.co/600x400/3455DB/FFFFFF/png?text=Ford+Mustang',
  ...
  },
  {
    ...
    year: 2022,
    price: 58000,
    imageUrl: 'https://placehold.co/600x400/FF0000/FFFFFF/png?text=Toyota+Supra',
  ...
  },
  {
    ...
    year: 2023,
    price: 43000,
    imageUrl: 'https://placehold.co/600x400/CCCCCC/000000/png?text=Civic+Type+R',
